...
INSERT INTO video (category_id, title, cover_url, description, sort_order, status, created_at, updated_at) VALUES
(1, '星际迷航：时空裂痕', '/uploads/covers/test-cover-1.jpg', '一支探险队在深空发现了神秘的时空裂痕，他们必须在宇宙崩塌前找到回家的路。', 1, 1, NOW(), NOW()),
(2, '暗影猎人', '/uploads/covers/test-cover-2.jpg', '一位神秘的赏金猎人在黑暗的城市中追踪危险的超自然生物，揭开隐藏的阴谋。', 2, 1, NOW(), NOW()),
(3, '记忆碎片', '/uploads/covers/test-cover-3.jpg', '一个失忆的男子醒来后发现自己卷入了一场危险的游戏，必须拼凑记忆找出真相。', 3, 1, NOW(), NOW()),
(1, '未来都市2099', '/uploads/covers/test-cover-4.jpg', '在2099年的未来都市，一名黑客发现了改变世界的秘密，引发了一场革命。', 4, 1, NOW(), NOW()),
(5, '深海探秘', '/uploads/covers/test-cover-5.jpg', '科学家团队潜入深海最深处，发现了一个未知的文明和令人震惊的秘密。', 5, 1, NOW(), NOW()),
(4, '魔法学院：觉醒', '/uploads/covers/test-cover-6.jpg', '一个普通学生进入神秘的魔法学院，发现自己拥有改变世界的强大力量。', 6, 1, NOW(), NOW()),
(2, '末日余生', '/uploads/covers/test-cover-7.jpg', '在末日后的废土世界，幸存者们为了生存和希望展开艰难的旅程。', 7, 0, NOW(), NOW()),
(2, '机械战警：重生', '/uploads/covers/test-cover-8.jpg', '一名被改造的机械战警在执行任务时发现了自己的人性，面临艰难的选择。', 8, 1, NOW(), NOW()),
(1, '平行世界', '/uploads/covers/test-cover-9.jpg', '物理学家意外打开了通往平行世界的大门，遇见了另一个自己。', 9, 1, NOW(), NOW()),
(3, '时间旅行者', '/uploads/covers/test-cover-10.jpg', '一位时间旅行者试图改变过去的悲剧，却发现每次改变都会带来意想不到的后果。', 10, 1, NOW(), NOW());
